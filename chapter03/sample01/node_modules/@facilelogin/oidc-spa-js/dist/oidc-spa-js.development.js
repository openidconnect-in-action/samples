(function (global, factory) {
    ...
    */
    ...
    var oauthToken = function (_a, worker) { return __awaiter(void 0, void 0, void 0, function () {
        var baseUrl = _a.baseUrl, timeout = _a.timeout, audience = _a.audience, token_ep = _a.token_ep, scope = _a.scope, options = __rest(_a, ["baseUrl", "timeout", "audience", "token_ep", "scope"]);
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, getJSON(token_ep === undefined ? baseUrl + "/token" : token_ep, timeout, audience || 'default', scope, {
                        method: 'POST',
    ...
    var getCustomInitialOptions = function (options) {
        var advancedOptions = options.advancedOptions, audience = options.audience, auth0Client = options.auth0Client, authorizeTimeoutInSeconds = options.authorizeTimeoutInSeconds, cacheLocation = options.cacheLocation, client_id = options.client_id, domain = options.domain, authorize_ep = options.authorize_ep, token_ep = options.token_ep, issuer = options.issuer, leeway = options.leeway, max_age = options.max_age, redirect_uri = options.redirect_uri, scope = options.scope, useRefreshTokens = options.useRefreshTokens, customParams = __rest(options, ["advancedOptions", "audience", "auth0Client", "authorizeTimeoutInSeconds", "cacheLocation", "client_id", "domain", "authorize_ep", "token_ep", "issuer", "leeway", "max_age", "redirect_uri", "scope", "useRefreshTokens"]);
        return customParams;
    };
    /**
    ...
    var Auth0Client = /** @class */ (function () {
        ...
        Auth0Client.prototype._getParams = function (authorizeOptions, state, nonce, code_challenge, redirect_uri) {
            var _a = this.options, domain = _a.domain, authorize_ep = _a.authorize_ep, leeway = _a.leeway, useRefreshTokens = _a.useRefreshTokens, auth0Client = _a.auth0Client, cacheLocation = _a.cacheLocation, advancedOptions = _a.advancedOptions, withoutDomain = __rest(_a, ["domain", "authorize_ep", "leeway", "useRefreshTokens", "auth0Client", "cacheLocation", "advancedOptions"]);
            return __assign(__assign(__assign({}, withoutDomain), authorizeOptions), { scope: getUniqueScopes(this.defaultScope, this.scope, authorizeOptions.scope), response_type: 'code', response_mode: 'query', state: state, authorize_ep: this.authzEp, nonce: nonce, redirect_uri: redirect_uri || this.options.redirect_uri, code_challenge: code_challenge, code_challenge_method: 'S256' });
        };
        Auth0Client.prototype._authorizeUrl = function (authorizeOptions) {
            ...
            return authorizeOptions.authorize_ep === undefined ? this._url("/authorize?" + createQueryParams(authorizeOptions))
                : authorizeOptions.authorize_ep + "?" + createQueryParams(authorizeOptions);
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            url = this._authorizeUrl(__assign(__assign({}, params), { prompt: 'none', response_mode: 'form_post' }));
                            //PRABATH: TODO
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, oauthToken(__assign(__assign(__assign({}, this.customOptions), customOptions), { scope: scope,
                                    audience: audience, baseUrl: this.domainUrl, token_ep: this.tokenEp, client_id: this.options.client_id, code_verifier: code_verifier, code: codeResult.code, grant_type: 'authorization_code', redirect_uri: params.redirect_uri }), this.worker)];
                        case 3:
                            tokenResult = _a.sent();
                    ...
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, oauthToken(__assign(__assign(__assign({}, this.customOptions), customOptions), { audience: audience,
                                    scope: scope, baseUrl: this.domainUrl, token_ep: this.tokenEp, client_id: this.options.client_id, grant_type: 'refresh_token', refresh_token: cache && cache.refresh_token, redirect_uri: redirect_uri }), this.worker)];
                        case 4:
                            tokenResult = _a.sent();
                            return [3 /*break*/, 8];
                        case 5:
...
//# sourceMappingURL=oidc-spa-js.development.js.map
